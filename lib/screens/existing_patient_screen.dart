...
class _ExistingPatientScreenState extends State<ExistingPatientScreen> {
  ...
  Future<void> _pickFileAndUpload(PatientProvider provider) async {
    if (_selectedPatientId == null) {
      ScaffoldMessenger.of(context)
          .showSnackBar(const SnackBar(content: Text('Please select a patient first')));
      return;
    }
    ...
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      content: Text(urls != null ? 'Uploaded successfully' : 'Upload failed'),
    ));
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Existing Patient - Reports',
          ...
          child: Column(children: [
              ...
              Expanded(
                child: SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    onPressed:
                    _uploading ? null : () => _pickFileAndUpload(provider),
            ...
            Expanded(
              child: _selectedPatientId == null
                  ? Center(
                child: Text(
                  'Select a patient to view uploaded reports',
  ...
  Widget _buildReportsView(PatientProvider provider) {
      ...
      itemBuilder: (ctx, i) {
        ...
        return Container(
          ...
          child: Row(children: [
            ...
            const SizedBox(width: 12),
            Expanded(
                child: Text('Report ${i + 1}',
                    style: GoogleFonts.inter(fontWeight: FontWeight.w600))),
            IconButton(
                onPressed: () {
                  // TODO: Implement view/download of report
                },
